...
- crates/AGENTS.md owns Rust core and CLI packages.
- app/AGENTS.md owns the Tauri and React desktop boundary; app/src/AGENTS.md owns React; app/src-tauri/AGENTS.md owns IPC and shell commands.
- docs/AGENTS.md owns durable documentation; docs/architecture/AGENTS.md owns implementation contracts.
- schemas/AGENTS.md owns versioned JSON contracts.
